...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final int DB_VERSION = 4; // v4: scores.difficulty
    ...
    public static final String C_SCORE_DIFFICULTY = "difficulty"; // 0=Normal, 1=Avançado
    ...
    public static final String C_Q_DIFFICULTY = "difficulty"; // 0=Normal, 1=Avançado
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String createScores = "CREATE TABLE " + T_SCORES + " (" +
                ...
                C_SCORE_DIFFICULTY + " INTEGER NOT NULL DEFAULT 0, " +
    ...
    public void onUpgrade(SQLiteDatabase db, int oldV, int newV) {
        // v2: garantir topics/questions/options (para quem vier da v1)
        if (oldV < 2) {
        ...
        // v3: garantir coluna difficulty em questions
        if (oldV < 3) {
            db.execSQL("ALTER TABLE " + T_QUESTIONS + " ADD COLUMN " +
                    C_Q_DIFFICULTY + " INTEGER NOT NULL DEFAULT 0");
        }
        // v4: adicionar difficulty em scores
        if (oldV < 4) {
            db.execSQL("ALTER TABLE " + T_SCORES + " ADD COLUMN " +
                    C_SCORE_DIFFICULTY + " INTEGER NOT NULL DEFAULT 0");
        }
    }
}